...
<!---->
<input role="switch" aria-checked="true" class="input artdeco-toggle__button artdeco-toggle__button--24dp" data-artdeco-toggle-button="true" id="fb-tfc-ember74" type="checkbox">
</div>
</div>
<!---->  </div>
...
<!---->
<input role="switch" aria-checked="true" class="input artdeco-toggle__button artdeco-toggle__button--24dp" data-artdeco-toggle-button="true" id="fb-tfc-ember82" type="checkbox">
</div>
</div>
<!---->  </div>
...
<!---->
<input role="switch" aria-checked="true" class="input artdeco-toggle__button artdeco-toggle__button--24dp" data-artdeco-toggle-button="true" id="fb-tfc-ember88" type="checkbox">
</div>
</div>
<!---->  </div>
...
<!---->
<input role="switch" aria-checked="true" class="input artdeco-toggle__button artdeco-toggle__button--24dp" data-artdeco-toggle-button="true" id="fb-tfc-ember94" type="checkbox">
</div>
</div>
<!---->  </div>
...
<!---->
<input role="switch" aria-checked="true" class="input artdeco-toggle__button artdeco-toggle__button--24dp" data-artdeco-toggle-button="true" id="fb-tfc-ember100" type="checkbox">
</div>
</div>
<!---->  </div>
...
Working with Artur was a fantastic experience. I found him a professional with great experience and profound knowledge of business solutions. He understands complex issues even when outside of his immediate area of expertise. Besides possessing excellent interpersonal skills, Artur has great relations with company clients and potential customers. He is not only a reliable and forward-thinking Cloud product Owner but also an inspiring team player.” 
...
<!---->    </div>
                  ...
                  <li class="pvs-list__paged-list-item artdeco-list__item pvs-list__item--line-separated pvs-list__item--one-column" id="profilePagedListComponent-ACoAABkJotcBqQV0qwgkWfYFQMpqxy60H90L5A8-RECOMMENDATIONS-VIEW-DETAILS-profileTabSection-RECEIVED-RECOMMENDATIONS-NONE-de-DE-11">
                    <div>
...
<!---->    <div class="fiYkWAneCjfDLVZlQFyELYViJrAdHBM
      ...
      <div>
        ...
        <a class="optional-action-target-wrapper 
            ...
            display-flex" target="_self" href="https://www.linkedin.com/in/wakeel-khan-5ba7b516b">
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
<!---->          <img width="48" src="https://media.licdn.com/dms/image/C4D03AQHf72wr-jjCuQ/profile-displayphoto-shrink_100_100/0/1634245930144?e=1724889600&amp;v=beta&amp;t=DLfrqnQfm5ymPWlWC6bzai8CwkwpImAiswSIU3hR0ao" loading="lazy" height="48" alt="Wakeel Khan profile picture" id="ember105" class="ivm-view-attr__img--centered EntityPhoto-circle-3   evi-image lazy-image ember-view">
    </div>
      ...
      <div class="display-flex flex-column full-width align-self-center">
        ...
        <a class="optional-action-target-wrapper 
              display-flex flex-column full-width" target="_self" href="https://www.linkedin.com/in/wakeel-khan-5ba7b516b">
            <div class="display-flex flex-wrap align-items-center full-height">
    ...
    <div class="display-flex ">
      ...
      <div class="
          ...
          <div class="display-flex align-items-center
              mr1 hoverable-link-text t-bold">
            <span aria-hidden="true"><!---->Wakeel Khan<!----></span><span class="visually-hidden"><!---->Wakeel Khan<!----></span>
          </div>
...
<!----><!---->                <span class="pvs-entity__supplementary-info t-14 t-black--light t-normal mr1">
                ...
                <span class="t-14 t-normal">
                  <span aria-hidden="true"><!---->CKA | CKAD | DevOps | Student at Otto-Frierich-Universität Bamberg<!----></span><span class="visually-hidden"><!---->CKA | CKAD | DevOps | Student at Otto-Frierich-Universität Bamberg<!----></span>
                </span>
              <span class="t-14 t-normal
                  t-black--light">
                <span class="pvs-entity__caption-wrapper" aria-hidden="true"><!---->May 11, 2023,<span class="white-space-pre"> </span><!---->Wakeel<!----><span class="white-space-pre"> </span>reported directly to<span class="white-space-pre"> </span><!---->Artur<!----></span><span class="visually-hidden"><!---->May 11, 2023,<span class="white-space-pre"> </span><!---->Wakeel<!----><span class="white-space-pre"> </span>reported directly to<span class="white-space-pre"> </span><!---->Artur<!----></span>
              </span>
<!---->          </a>
...
<!---->
      ...
      <div>
        ...
        <a class="optional-action-target-wrapper artdeco-button artdeco-button--tertiary artdeco-button--standard artdeco-button--3 artdeco-button--muted artdeco-button--circle
            ...
            " target="_self" aria-hidden="false" id="navigation-add-edit-recommendation-deeplink-edit-recommendations" href="https://www.linkedin.com/in/artur-schulz-473817b8/recommendation-add-edit/REQUEST_RECOMMENDATION?profileFormEntryPoint=PROFILE_SECTION&amp;trackingId=%2F5u21YfLQ4SFVsM%2F9J%2BmRA%3D%3D&amp;desktopBackground=PROFILE_DETAIL_SCREEN&amp;recommendationId=745423174">
            <div class="pvs-navigation__icon">
              <svg role="img" aria-hidden="false" aria-label="Edit recommendation Wakeel Khan" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" data-supported-dps="24x24" data-test-icon="edit-medium">
<!---->    
    <use href="#edit-medium" width="24" height="24"></use>
</svg>
...
<!---->    
  ...
  <label data-test-toggle-form-component-external-label="" for="fb-tfc-ember106" class="fb-toggle-form-component__external-label">
    <span aria-hidden="true"><!---->All LinkedIn members<!----></span><span class="visually-hidden"><!---->Show Wakeel Khan recommendation to All LinkedIn members<!----></span>
  </label>
  <div data-control-name="visibility_received_tab" id="ember107" class="fb-toggle-form-component__toggle artdeco-toggle artdeco-toggle--24dp artdeco-toggle--default artdeco-toggle--toggled ember-view" data-test-toggle-form-component__toggle=""><span aria-hidden="true" class="artdeco-toggle__text" data-artdeco-toggle-text="true" data-artdeco-toggled="">
    On
</span>
<!---->
<input role="switch" aria-checked="true" class="input artdeco-toggle__button artdeco-toggle__button--24dp" data-artdeco-toggle-button="true" id="fb-tfc-ember106" type="checkbox">
</div>
</div>
<!---->  </div>
...
<!---->        <ul class="JqegKNdFksBrpGlantOqHToYlUTqPHB
    ...
    <div class="display-flex ">
      ...
      <div class="
          ...
          <div class="display-flex align-items-center
              t-14 t-normal t-black">
            <span aria-hidden="true"><!---->I had the pleasure of working under the guidance of Artur Schulz during my time at Mercedes-Benz. As my manager, Artur provided me with exceptional mentorship and support, and I am grateful for the experience.<span class="white-space-pre"> </span><br><br><!---->Artur has a deep understanding of the industry and a vast knowledge of best practices. He was always available to answer my questions and provide guidance, which helped me to grow professionally and perform at my best.<span class="white-space-pre"> </span><br><br><!---->Artur is an excellent communicator, and he sets clear expectations for his team members. He was always approachable and open to feedback, which made for a positive and collaborative work environment.<span class="white-space-pre"> </span><br><br><!---->I highly recommend Artur Schulz for any leadership position. His dedication to his work and his team is evident, and I am confident that he would be an asset to any organization.<!----></span><span class="visually-hidden"><!---->I had the pleasure of working under the guidance of Artur Schulz during my time at Mercedes-Benz. As my manager, Artur provided me with exceptional mentorship and support, and I am grateful for the experience. 

Artur has a deep understanding of the industry and a vast knowledge of best practices. He was always available to answer my questions and provide guidance, which helped me to grow professionally and perform at my best. 

Artur is an excellent communicator, and he sets clear expectations for his team members. He was always approachable and open to feedback, which made for a positive and collaborative work environment. 

I highly recommend Artur Schulz for any leadership position. His dedication to his work and his team is evident, and I am confident that he would be an asset to any organization.<!----></span>
          </div>
...
<!---->    
          ...
          <div tabindex="0" hidden="" id="ember108" class="artdeco-tabpanel artdeco-tabpanel--hidden ember-view" role="tabpanel" aria-labelledby="ember72">
  ...
  <!---->
      ...
      <div class="scaffold-finite-scroll__content">
              ...
              <ul class="JqegKNdFksBrpGlantOqHToYlUTqPHB " tabindex="-1">
                  <li class="pvs-list__paged-list-item artdeco-list__item pvs-list__item--line-separated pvs-list__item--one-column" id="profilePagedListComponent-ACoAABkJotcBqQV0qwgkWfYFQMpqxy60H90L5A8-RECOMMENDATIONS-VIEW-DETAILS-profileTabSection-GIVEN-RECOMMENDATIONS-NONE-de-DE-0">
                    <div>
...
<!---->    <div class="fiYkWAneCjfDLVZlQFyELYViJrAdHBM
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
<!---->          <img width="48" src="https://media.licdn.com/dms/image/D4D03AQF2IY-XUpUJ-A/profile-displayphoto-shrink_100_100/0/1711449657053?e=1724889600&amp;v=beta&amp;t=FLYNW7nT2DaFJqy0RyhNo6XkuXl--BK13ALGVADxFlA" loading="lazy" height="48" alt="Joseph Singh-Francois profile picture" id="ember109" class="ivm-view-attr__img--centered EntityPhoto-circle-3   evi-image lazy-image ember-view">
    </div>
...
<!---->
        <li-icon aria-hidden="true" type="linkedin-bug" class="ivm-view-attr__icon ivm-view-attr__icon--premium-inbug  " size="14dp" color="premium" is-loading="true"></li-icon>
              ...
              <span class="t-14 t-normal
                  t-black--light">
                <span class="pvs-entity__caption-wrapper" aria-hidden="true"><!---->September 14, 2023,<span class="white-space-pre"> </span><!---->Artur<!----><span class="white-space-pre"> </span>worked with<span class="white-space-pre"> </span><!---->Joseph<!----><span class="white-space-pre"> </span>but they were at different companies<!----></span><span class="visually-hidden"><!---->September 14, 2023,<span class="white-space-pre"> </span><!---->Artur<!----><span class="white-space-pre"> </span>worked with<span class="white-space-pre"> </span><!---->Joseph<!----><span class="white-space-pre"> </span>but they were at different companies<!----></span>
              </span>
<!---->          </a>
...
<!---->
    ...
    <div id="ember110" class="artdeco-dropdown artdeco-dropdown--placement-bottom artdeco-dropdown--justification-right ember-view">
      <button aria-expanded="false" id="overflow-Recommendations-overflow-menu-for-Joseph-Singh-Francois" class="artdeco-dropdown__trigger artdeco-dropdown__trigger--placement-bottom ember-view artdeco-button artdeco-button--circle artdeco-button--muted artdeco-button--3 artdeco-button--tertiary artdeco-button-dropdown-trigger
          " type="button" tabindex="0">
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
        <li-icon type="overflow-web-ios" class="ivm-view-attr__icon  " size="large" is-loading="true" role="img" aria-label="Recommendations overflow menu for Joseph Singh-Francois"></li-icon>
    </div>
...
<!----></button>
      <div tabindex="-1" aria-hidden="true" id="ember112" class="artdeco-dropdown__content artdeco-dropdown--is-dropdown-element artdeco-dropdown__content--justification-right artdeco-dropdown__content--placement-bottom ember-view pvs-overflow-content--width"><!----></div>
    </div>

    <div id="ember113" class="ember-view"><div id="ember114" class="ember-view"><!----></div></div>
...
<div id="ember115" class="artdeco-dropdown artdeco-dropdown--placement-bottom artdeco-dropdown--justification-left ember-view" data-test-visibility-setting-button="">
  <button aria-expanded="false" id="radio-button-form-component-profileViewFormElement-recommendation-753269764-RECOMMENDATION-RECOMMENDER-VISIBILITY-vsb" class="artdeco-dropdown__trigger artdeco-dropdown__trigger--placement-bottom ember-view artdeco-button artdeco-button--muted artdeco-button--2 artdeco-button--secondary mt2" data-test-visibility-setting-button__trigger="" type="button" tabindex="0">
    <div class="display-flex align-items-center
        ">
        <svg role="none" aria-hidden="true" class="artdeco-button__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" data-supported-dps="16x16" data-test-icon="visibility-small">
<!---->    
    <use href="#visibility-small" width="16" height="16"></use>
</svg>
...
<!----></button>
  ...
  <div tabindex="-1" aria-hidden="true" id="ember117" class="artdeco-dropdown__content artdeco-dropdown--is-dropdown-element artdeco-dropdown__content--justification-left artdeco-dropdown__content--placement-bottom ember-view fb-visibility-setting-button-content" data-test-visibility-setting-button__content=""><!----></div>
</div>

  <div id="radio-button-form-component-profileViewFormElement-recommendation-753269764-RECOMMENDATION-RECOMMENDER-VISIBILITY-error">
<!----></div>
...
<!---->        <ul class="JqegKNdFksBrpGlantOqHToYlUTqPHB
    ...
    <div class="display-flex ">
      ...
      <div class="
          ...
          <div class="display-flex align-items-center
              t-14 t-normal t-black">
            <span aria-hidden="true"><!---->Joseph played a pivotal role in our data center infrastructure transition and transformation project, showcasing his exceptional expertise and leadership abilities.<!----><br><!---->Joseph meticulous creation of knowledge plans, his adeptness in establishing crucial external relationships, and his optimization of our ServiceNow setup were instrumental in our project's success. Beyond these technical skills an understanding, Josephs leadership behavior stood out. He navigated the complexities of our environment with grace, consistently identifying the right triggers to move us forward.<!----><br><!---->Joseph is not only a reliable and self-motivated IT expert but also an inspirational leader who motivates those around him. His dedication to excellence is evident in every task he undertakes.<!----></span><span class="visually-hidden"><!---->Joseph played a pivotal role in our data center infrastructure transition and transformation project, showcasing his exceptional expertise and leadership abilities.
Joseph meticulous creation of knowledge plans, his adeptness in establishing crucial external relationships, and his optimization of our ServiceNow setup were instrumental in our project's success. Beyond these technical skills an understanding, Josephs leadership behavior stood out. He navigated the complexities of our environment with grace, consistently identifying the right triggers to move us forward.
Joseph is not only a reliable and self-motivated IT expert but also an inspirational leader who motivates those around him. His dedication to excellence is evident in every task he undertakes.<!----></span>
          </div>
...
<!---->    </div>
                  ...
                  <li class="pvs-list__paged-list-item artdeco-list__item pvs-list__item--line-separated pvs-list__item--one-column" id="profilePagedListComponent-ACoAABkJotcBqQV0qwgkWfYFQMpqxy60H90L5A8-RECOMMENDATIONS-VIEW-DETAILS-profileTabSection-GIVEN-RECOMMENDATIONS-NONE-de-DE-1">
                    <div>
...
<!---->    <div class="fiYkWAneCjfDLVZlQFyELYViJrAdHBM
      ...
      <div>
        ...
        <a class="optional-action-target-wrapper 
            ...
            display-flex" target="_self" href="https://www.linkedin.com/in/tyagu-c-b21b2614">
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
<!---->          <img width="48" src="https://media.licdn.com/dms/image/C5603AQGWTSu3fnPxAA/profile-displayphoto-shrink_100_100/0/1516524596451?e=1724889600&amp;v=beta&amp;t=VX2qqMr5vOBqR2MEfBpKgZJ-i3nJV_olnCr7b_T_mSA" loading="lazy" height="48" alt="Tyagu C profile picture" id="ember118" class="ivm-view-attr__img--centered EntityPhoto-circle-3   evi-image lazy-image ember-view">
    </div>
      ...
      <div class="display-flex flex-column full-width align-self-center">
        ...
        <a class="optional-action-target-wrapper 
              display-flex flex-column full-width" target="_self" href="https://www.linkedin.com/in/tyagu-c-b21b2614">
            <div class="display-flex flex-wrap align-items-center full-height">
    ...
    <div class="display-flex ">
      ...
      <div class="
          ...
          <div class="display-flex align-items-center
              mr1 hoverable-link-text t-bold">
            <span aria-hidden="true"><!---->Tyagu C<!----></span><span class="visually-hidden"><!---->Tyagu C<!----></span>
          </div>
...
<!----><!---->                <span class="pvs-entity__supplementary-info t-14 t-black--light t-normal mr1">
                ...
                <span class="t-14 t-normal">
                  <span aria-hidden="true"><!---->Senior Consultant | ISTQB(CTFL, AuT) | Scrum(PSM I, PSPO I)<!----></span><span class="visually-hidden"><!---->Senior Consultant | ISTQB(CTFL, AuT) | Scrum(PSM I, PSPO I)<!----></span>
                </span>
              <span class="t-14 t-normal
                  t-black--light">
                <span class="pvs-entity__caption-wrapper" aria-hidden="true"><!---->September 5, 2023,<span class="white-space-pre"> </span><!---->Artur<!----><span class="white-space-pre"> </span>was Tyagu’s teacher<!----></span><span class="visually-hidden"><!---->September 5, 2023,<span class="white-space-pre"> </span><!---->Artur<!----><span class="white-space-pre"> </span>was Tyagu’s teacher<!----></span>
              </span>
<!---->          </a>
...
<!---->
    ...
    <div id="ember119" class="artdeco-dropdown artdeco-dropdown--placement-bottom artdeco-dropdown--justification-right ember-view">
      <button aria-expanded="false" id="overflow-Recommendations-overflow-menu-for-Tyagu-C" class="artdeco-dropdown__trigger artdeco-dropdown__trigger--placement-bottom ember-view artdeco-button artdeco-button--circle artdeco-button--muted artdeco-button--3 artdeco-button--tertiary artdeco-button-dropdown-trigger
          " type="button" tabindex="0">
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
        <li-icon type="overflow-web-ios" class="ivm-view-attr__icon  " size="large" is-loading="true" role="img" aria-label="Recommendations overflow menu for Tyagu C"></li-icon>
    </div>
...
<!----></button>
      <div tabindex="-1" aria-hidden="true" id="ember121" class="artdeco-dropdown__content artdeco-dropdown--is-dropdown-element artdeco-dropdown__content--justification-right artdeco-dropdown__content--placement-bottom ember-view pvs-overflow-content--width"><!----></div>
    </div>

    <div id="ember122" class="ember-view"><div id="ember123" class="ember-view"><!----></div></div>
...
<div id="ember124" class="artdeco-dropdown artdeco-dropdown--placement-bottom artdeco-dropdown--justification-left ember-view" data-test-visibility-setting-button="">
  <button aria-expanded="false" id="radio-button-form-component-profileViewFormElement-recommendation-752630764-RECOMMENDATION-RECOMMENDER-VISIBILITY-vsb" class="artdeco-dropdown__trigger artdeco-dropdown__trigger--placement-bottom ember-view artdeco-button artdeco-button--muted artdeco-button--2 artdeco-button--secondary mt2" data-test-visibility-setting-button__trigger="" type="button" tabindex="0">
    <div class="display-flex align-items-center
        ">
        <svg role="none" aria-hidden="true" class="artdeco-button__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" data-supported-dps="16x16" data-test-icon="visibility-small">
<!---->    
...
<!----></button>
  ...
  <div tabindex="-1" aria-hidden="true" id="ember126" class="artdeco-dropdown__content artdeco-dropdown--is-dropdown-element artdeco-dropdown__content--justification-left artdeco-dropdown__content--placement-bottom ember-view fb-visibility-setting-button-content" data-test-visibility-setting-button__content=""><!----></div>
</div>

  <div id="radio-button-form-component-profileViewFormElement-recommendation-752630764-RECOMMENDATION-RECOMMENDER-VISIBILITY-error">
<!----></div>
...
<!---->        <ul class="JqegKNdFksBrpGlantOqHToYlUTqPHB
    ...
    <div class="display-flex ">
      ...
      <div class="
          ...
          <div class="display-flex align-items-center
              t-14 t-normal t-black">
            <span aria-hidden="true"><!---->I had the pleasure of working closely with Tyagu during our time at Mercedes-Benz Tech Innovation in the Team "Connected Cars - Test" where he served as a Senior Software Test Engineer on Mercedes me connect project. Tyagu demonstrated exceptional dedication and a rapid learning curve, quickly taking charge of test planning and executing multiple feature groups independently.<!----><br><br><!---->Tyagu is a proactive team player with strong technical skills and a keen attention to detail. He consistently delivers high-quality results and is always eager to take on new challenges.<!----><br><br><!---->I wholeheartedly recommend Tyagu as a valuable colleague to any team. His expertise and drive are sure to make a positive impact. It was a pleasure working alongside Tyagu,<!----></span><span class="visually-hidden"><!---->I had the pleasure of working closely with Tyagu during our time at Mercedes-Benz Tech Innovation in the Team "Connected Cars - Test" where he served as a Senior Software Test Engineer on Mercedes me connect project. Tyagu demonstrated exceptional dedication and a rapid learning curve, quickly taking charge of test planning and executing multiple feature groups independently.

Tyagu is a proactive team player with strong technical skills and a keen attention to detail. He consistently delivers high-quality results and is always eager to take on new challenges.

I wholeheartedly recommend Tyagu as a valuable colleague to any team. His expertise and drive are sure to make a positive impact. It was a pleasure working alongside Tyagu,<!----></span>
          </div>
...
<!---->    </div>
                  ...
                  <li class="pvs-list__paged-list-item artdeco-list__item pvs-list__item--line-separated pvs-list__item--one-column" id="profilePagedListComponent-ACoAABkJotcBqQV0qwgkWfYFQMpqxy60H90L5A8-RECOMMENDATIONS-VIEW-DETAILS-profileTabSection-GIVEN-RECOMMENDATIONS-NONE-de-DE-2">
                    <div>
...
<!---->    <div class="fiYkWAneCjfDLVZlQFyELYViJrAdHBM
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
<!---->          <img width="48" src="https://media.licdn.com/dms/image/D5603AQFrvRpbjbXRZA/profile-displayphoto-shrink_100_100/0/1675887660325?e=1724889600&amp;v=beta&amp;t=6nhAVGh77aEvzh2vaTzxgWt3lwJRA6imAMwFruvb-Oc" loading="lazy" height="48" alt="Ramakrishna A profile picture" id="ember127" class="ivm-view-attr__img--centered EntityPhoto-circle-3   evi-image lazy-image ember-view">
    </div>
...
<!----><!---->                <span class="pvs-entity__supplementary-info t-14 t-black--light t-normal mr1">
              ...
              <span class="t-14 t-normal
                  t-black--light">
                <span class="pvs-entity__caption-wrapper" aria-hidden="true"><!---->June 22, 2023,<span class="white-space-pre"> </span><!---->Artur<!----><span class="white-space-pre"> </span>worked with<span class="white-space-pre"> </span><!---->Ramakrishna<!----><span class="white-space-pre"> </span>on the same team<!----></span><span class="visually-hidden"><!---->June 22, 2023,<span class="white-space-pre"> </span><!---->Artur<!----><span class="white-space-pre"> </span>worked with<span class="white-space-pre"> </span><!---->Ramakrishna<!----><span class="white-space-pre"> </span>on the same team<!----></span>
              </span>
<!---->          </a>
...
<!---->
    ...
    <div id="ember128" class="artdeco-dropdown artdeco-dropdown--placement-bottom artdeco-dropdown--justification-right ember-view">
      <button aria-expanded="false" id="overflow-Recommendations-overflow-menu-for-Ramakrishna-A" class="artdeco-dropdown__trigger artdeco-dropdown__trigger--placement-bottom ember-view artdeco-button artdeco-button--circle artdeco-button--muted artdeco-button--3 artdeco-button--tertiary artdeco-button-dropdown-trigger
          " type="button" tabindex="0">
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
        <li-icon type="overflow-web-ios" class="ivm-view-attr__icon  " size="large" is-loading="true" role="img" aria-label="Recommendations overflow menu for Ramakrishna A"></li-icon>
    </div>
...
<!----></button>
      <div tabindex="-1" aria-hidden="true" id="ember130" class="artdeco-dropdown__content artdeco-dropdown--is-dropdown-element artdeco-dropdown__content--justification-right artdeco-dropdown__content--placement-bottom ember-view pvs-overflow-content--width"><!----></div>
    </div>

    <div id="ember131" class="ember-view"><div id="ember132" class="ember-view"><!----></div></div>
...
<div id="ember133" class="artdeco-dropdown artdeco-dropdown--placement-bottom artdeco-dropdown--justification-left ember-view" data-test-visibility-setting-button="">
  <button aria-expanded="false" id="radio-button-form-component-profileViewFormElement-recommendation-748080254-RECOMMENDATION-RECOMMENDER-VISIBILITY-vsb" class="artdeco-dropdown__trigger artdeco-dropdown__trigger--placement-bottom ember-view artdeco-button artdeco-button--muted artdeco-button--2 artdeco-button--secondary mt2" data-test-visibility-setting-button__trigger="" type="button" tabindex="0">
    <div class="display-flex align-items-center
        ">
        <svg role="none" aria-hidden="true" class="artdeco-button__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" data-supported-dps="16x16" data-test-icon="visibility-small">
<!---->    
...
<!----></button>
  ...
  <div tabindex="-1" aria-hidden="true" id="ember135" class="artdeco-dropdown__content artdeco-dropdown--is-dropdown-element artdeco-dropdown__content--justification-left artdeco-dropdown__content--placement-bottom ember-view fb-visibility-setting-button-content" data-test-visibility-setting-button__content=""><!----></div>
</div>

  <div id="radio-button-form-component-profileViewFormElement-recommendation-748080254-RECOMMENDATION-RECOMMENDER-VISIBILITY-error">
<!----></div>
...
<!---->        <ul class="JqegKNdFksBrpGlantOqHToYlUTqPHB
    ...
    <div class="display-flex ">
      ...
      <div class="
          ...
          <div class="display-flex align-items-center
              t-14 t-normal t-black">
            <span aria-hidden="true"><!---->I had the pleasure of working closely with Ramakrishna, who played a key role in our team providing Cloud Administration, DevOps, and security services to our business. Working together, we were able to improve our service KPI's, deliver professional results and safe money. I greatly appreciate Ramakrishna's reliability, his willingness to go the extra mile and his drive for personal development and learning.<!----><br><br><!---->Ramakrishna's contributions as a Cloud Operations Engineer in Mercedes-Benz were invaluable, consistently saving our business from production outages. Throughout his Involvement MBRDI he developed strong Kubernetis and IoT skills and enhanced our capabilities, making him a valuable asset for any organization in need of a talented professional in these areas.<!----></span><span class="visually-hidden"><!---->I had the pleasure of working closely with Ramakrishna, who played a key role in our team providing Cloud Administration, DevOps, and security services to our business. Working together, we were able to improve our service KPI's, deliver professional results and safe money. I greatly appreciate Ramakrishna's reliability, his willingness to go the extra mile and his drive for personal development and learning.

Ramakrishna's contributions as a Cloud Operations Engineer in Mercedes-Benz were invaluable, consistently saving our business from production outages. Throughout his Involvement MBRDI he developed strong Kubernetis and IoT skills and enhanced our capabilities, making him a valuable asset for any organization in need of a talented professional in these areas.<!----></span>
          </div>
