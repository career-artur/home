...
<!---->
          ...
          <div id="recommendations" class="pv-profile-card__anchor">
          </div>
<!---->            
          
<!---->
    <div class="jUjEqPqevwXmtdsLSeUjlpUBNyoeuiHfpbdik">
      <div class="pvs-header__top-container--no-stack">
        <div class="pvs-header__left-container--stack">
          <div class="mMajiqirBBnmqrfyDqRKhsHGScWaYpQhYyIMnys">
...
<!---->        </div>
    ...
    <div id="ember7735" class="artdeco-dropdown artdeco-dropdown--placement-bottom artdeco-dropdown--justification-right ember-view">
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
        <li-icon type="add" class="ivm-view-attr__icon  " size="large" role="img" aria-label="Recommendations overflow menu"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="mercado-match" width="24" height="24" focusable="false">
...
<!----></button>
      <div tabindex="-1" aria-hidden="true" id="ember7737" class="artdeco-dropdown__content artdeco-dropdown--is-dropdown-element artdeco-dropdown__content--justification-right artdeco-dropdown__content--placement-bottom ember-view pvs-overflow-content--width"><!----></div>
    </div>

    <div id="ember7738" class="ember-view"><div id="ember7739" class="ember-view"><!----></div></div>
      ...
      <div>
        ...
        <a class="optional-action-target-wrapper artdeco-button artdeco-button--tertiary artdeco-button--standard artdeco-button--3 artdeco-button--muted artdeco-button--circle
            ...
            " target="_self" aria-hidden="false" id="navigation-index-edit-recommendations" href="https://www.linkedin.com/in/artur-schulz-473817b8/details/recommendations?profileUrn=urn%3Ali%3Afsd_profile%3AACoAABkJotcBqQV0qwgkWfYFQMpqxy60H90L5A8">
            <div class="pvs-navigation__icon">
              <svg role="img" aria-hidden="false" aria-label="View recommendations detail screen" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" data-supported-dps="24x24" data-test-icon="edit-medium">
<!---->    
...
<!----><!---->        </a>
      ...
      <div id="ember7740" class="artdeco-tabs artdeco-tabs--size-t-48 ember-view">
          <div aria-multiselectable="false" id="ember7741" class="artdeco-tablist ember-view" role="tablist">
              <button tabindex="0" aria-selected="true" id="ember7742" class="artdeco-tab active artdeco-tab--selected ember-view" role="tab" aria-controls="ember7744">
                <span aria-hidden="true"><!---->Received<!----></span><span class="visually-hidden"><!---->Received<!----></span>
              </button>

              <button tabindex="-1" aria-selected="false" id="ember7743" class="artdeco-tab ember-view" role="tab" aria-controls="ember7746">
                <span aria-hidden="true"><!---->Given<!----></span><span class="visually-hidden"><!---->Given<!----></span>
              </button>

          
</div>
          <div tabindex="0" id="ember7744" class="artdeco-tabpanel active ember-view" role="tabpanel" aria-labelledby="ember7742">
              
          
    <div class="OqRBmONpFSLEnJVMHrIJzxqQrJFnwhfVJISw">
<!---->        <ul class="GbhAPdrqCnMmcWsAmrTrSbiADqzaZFRXhAuNcs
            
            
            ">
            <li class="artdeco-list__item xuYDvNkiBKWkPnSTodmpUrYZOcHiwzjvlBDOQ OFwtNsOmAURPUuKdxiCXNJdCLEmjSwTkd">
              
          
<!---->    <div class="rWfSGUOqukdTRNpNdGHVkrRuChdNBgXwfxg
        pYEZEZZGnBUqROtmJUcdHOGSqIxYAumgk ZzbozdeyJeCERPOYDGYVKfZzosfNnwvGozgU
...
<!---->
    ...
    <div class="OqRBmONpFSLEnJVMHrIJzxqQrJFnwhfVJISw pvs-entity__sub-components">
<!---->        <ul class="GbhAPdrqCnMmcWsAmrTrSbiADqzaZFRXhAuNcs
            
            
            ">
            <li class="OFwtNsOmAURPUuKdxiCXNJdCLEmjSwTkd">
...
<!---->        <ul class="GbhAPdrqCnMmcWsAmrTrSbiADqzaZFRXhAuNcs
            ...
            ">
            <li class="pvs-list__item--with-top-padding OFwtNsOmAURPUuKdxiCXNJdCLEmjSwTkd">
    ...
    <div class="display-flex ">
      ...
      <div class="PVQiTBEtSvrwnXGywMJBLsNGisqNglPEFU
          full-width t-14 t-normal t-black display-flex align-items-center">
        
    <div class="FfiTPVemLDHVJelDVUvkZQGJYAjiEMSb
        inline-show-more-text--is-collapsed
        inline-show-more-text--is-collapsed-with-line-clamp
        
        
         full-width" style="-webkit-line-clamp:8;" tabindex="-1">
...
<!---->    </div>
      ...
      <div>
        ...
        <a class="optional-action-target-wrapper artdeco-button artdeco-button--tertiary artdeco-button--standard artdeco-button--2 artdeco-button--muted 
            ...
            " target="_self" aria-hidden="false" id="navigation-index-see-all-recommendations" href="https://www.linkedin.com/in/artur-schulz-473817b8/details/recommendations?profileUrn=urn%3Ali%3Afsd_profile%3AACoAABkJotcBqQV0qwgkWfYFQMpqxy60H90L5A8&amp;tabIndex=0&amp;detailScreenTabIndex=0">
...
<!---->    
    <use href="#arrow-right-small" width="16" height="16"></use>
          ...
          <div tabindex="0" hidden="" id="ember7746" class="artdeco-tabpanel artdeco-tabpanel--hidden ember-view" role="tabpanel" aria-labelledby="ember7743">
...
<!---->    <div class="rWfSGUOqukdTRNpNdGHVkrRuChdNBgXwfxg
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
<!---->          <img width="48" src="https://media.licdn.com/dms/image/D4D03AQF2IY-XUpUJ-A/profile-displayphoto-shrink_100_100/0/1711449657053?e=1724889600&amp;v=beta&amp;t=FLYNW7nT2DaFJqy0RyhNo6XkuXl--BK13ALGVADxFlA" loading="lazy" height="48" alt="Joseph Singh-Francois profile picture" id="ember7747" class="ivm-view-attr__img--centered EntityPhoto-circle-3   evi-image lazy-image ember-view">
    </div>
...
<!---->    <div class="rWfSGUOqukdTRNpNdGHVkrRuChdNBgXwfxg
    ...
    <div class="ivm-view-attr__img-wrapper
        ...
        ">
<!---->
<!---->          <img width="48" src="https://media.licdn.com/dms/image/C5603AQGWTSu3fnPxAA/profile-displayphoto-shrink_100_100/0/1516524596451?e=1724889600&amp;v=beta&amp;t=VX2qqMr5vOBqR2MEfBpKgZJ-i3nJV_olnCr7b_T_mSA" loading="lazy" height="48" alt="Tyagu C profile picture" id="ember7748" class="ivm-view-attr__img--centered EntityPhoto-circle-3   evi-image lazy-image ember-view">
    </div>
...
<!---->    </div>
      ...
      <div>
        ...
        <a class="optional-action-target-wrapper artdeco-button artdeco-button--tertiary artdeco-button--standard artdeco-button--2 artdeco-button--muted 
            ...
            " target="_self" aria-hidden="false" id="navigation-index-see-all-recommendations" href="https://www.linkedin.com/in/artur-schulz-473817b8/details/recommendations?profileUrn=urn%3Ali%3Afsd_profile%3AACoAABkJotcBqQV0qwgkWfYFQMpqxy60H90L5A8&amp;tabIndex=1&amp;detailScreenTabIndex=1">
<!---->            <span class="pvs-navigation__text">
              Show all 3 given
            </span>
            <div class="pvs-navigation__icon">
